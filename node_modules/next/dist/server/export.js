...
exports.default = function () {
  var _ref = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee(dir, options) {
    var outDir, nextDir, config, buildId, buildStats, exportPathMap, exportPaths, renderOpts, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, path, _exportPathMap$path, page, query, req, res, htmlFilename, baseDir, htmlFilepath, html, log;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 41:
            ...
            _exportPathMap$path = exportPathMap[path], page = _exportPathMap$path.page, query = _exportPathMap$path.query;
            req = { url: path };
            res = {};
